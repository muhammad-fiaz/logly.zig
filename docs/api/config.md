...
Logly v0.2.1 supports parsing and loading configuration dynamically from JSON files and slices. Standard configurations can be easily loaded using these helpers:
