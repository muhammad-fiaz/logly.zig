...
```bash
zig fetch --save https://github.com/muhammad-fiaz/logly.zig/archive/refs/tags/0.0.6.tar.gz
```
...
```bash
zig fetch https://github.com/muhammad-fiaz/logly.zig/archive/refs/tags/0.0.6.tar.gz
```
