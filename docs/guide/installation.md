...
```bash
zig fetch https://github.com/muhammad-fiaz/logly.zig/archive/refs/tags/0.1.5.tar.gz
```
...
```bash
zig fetch https://github.com/muhammad-fiaz/logly.zig/archive/refs/tags/0.1.4.tar.gz
```
