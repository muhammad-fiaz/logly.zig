  ...
  head: [
    ...
    [
      "meta",
      {
        ...
        content: "Logly.zig - High Performance Zig Logging Library",
      },
    ],
...
gtag('config', '${GA_ID}');`,
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Dynamic Thread Pool", link: "/guide/dynamic-thread-pool" },
          ...
          { text: "Memory Telemetry", link: "/guide/memory-telemetry" },
          { text: "Custom Sinks", link: "/guide/custom-sink" },
          { text: "std.log Integration", link: "/guide/std-log-integration" },
          { text: "Fast JSON", link: "/guide/fast-json" },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Memory Tracker", link: "/api/memory-tracker" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Dynamic Thread Pool", link: "/examples/dynamic-thread-pool" },
          ...
          { text: "Memory Telemetry", link: "/examples/memory-telemetry" },
          { text: "Custom Sink", link: "/examples/custom-sink" },
          { text: "std.log Integration", link: "/examples/std-log-integration" },
          { text: "Fast JSON", link: "/examples/fast-json" },
        ],
      },
    ],
    ...
    editLink: {
      pattern:
        "https://github.com/muhammad-fiaz/logly.zig/edit/main/docs/:path",
